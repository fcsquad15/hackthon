...
rotas.get('/forum/comentarios', forum.listarComentarios);
rotas.post('/forum/:id', forum.criarPergunta); // id do usuário
rotas.post('/forum/comentarios/:id', forum.comentarPergunta); // id do usuário
